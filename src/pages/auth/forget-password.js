                  ...
                  <div className="grid grid-cols-1 gap-5">
                    ...
                    {loading ? (
                      ...
                      <button
                        disabled={loading}
                        type="submit"
                        className="w-full text-center py-3 rounded bg-customRed text-white hover:bg-red-500 transition-all focus:outline-none my-1"
                      >
                        Recover password
                      </button>
                    )}
